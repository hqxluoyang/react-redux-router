	    ...
	    _createClass(Treepanel, [{
	        ...
	        */
	        ...
	        value: function getKeyFrames() {
	            return [{ transform: 'scale(1)', opacity: 1, offset: 0 }, { transform: 'scale(1)', opacity: 0.5, offset: 0.3 }, { transform: 'scale(1)', opacity: 0.667, offset: 0.7875 }, { transform: 'scale(1)', opacity: 0.6, offset: 1 }];
	        }
	    }, {
	        key: 'getTiming',
