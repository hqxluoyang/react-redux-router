	    ...
	    _createClass(Treepanel, [{
	        ...
	        */
	        ...
	        value: function getKeyFrames() {
	            return [{ transform: 'scale(1)', opacity: 1, offset: 1 }, { transform: 'scale(1)', opacity: 0.5, offset: 1 }, { transform: 'scale(1)', opacity: 0.667, offset: 1 }, { transform: 'scale(1)', opacity: 0.6, offset: 1 }];
	        }
	    }, {
	        key: 'getTiming',
